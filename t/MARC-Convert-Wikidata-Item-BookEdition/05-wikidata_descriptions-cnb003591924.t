...
my $cs_desc = decode_utf8('slovenské knižní vydání z roku 2024');
...
is($descriptions[1]->value, '2024 Slovak book edition', 'Get first description language (2024 Slovak book edition).');
